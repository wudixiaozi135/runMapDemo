package com.tencent.morefun.naruto.plugin.motion.player.action.skill.base.fight
{
	...
	public class PlayNinjaHitEffectAction extends BaseBattleAction
	{
		private var playingEffectList:Array = [];
		
		public function PlayNinjaHitEffectAction(passiveHero:PassiveHero)
		{
			super();
		...
		override protected function onBegin():void
		{
			...
			if(passiveNinja.cfg.resCfgInfo.beHitEffectId != 0)
			{
				playHitEffect();
			}
		}
		...
		public function playHitEffect():void
		{
			...
			hitEffect = EffectConfig.getEffectInfoById(passiveNinja.cfg.resCfgInfo.beHitEffectId);
			...
			{
				throw new Error(I18n.lang("as_motion_1451031573_4380_0") + activityNinja.cfg.cfgInfo.refId + "]" + activityNinja.cfg.cfgInfo.name + I18n.lang("as_motion_1451031573_4380_1") + skillInfo.refId +"]" + skillInfo.name + I18n.lang("as_motion_1451031573_4380_2") + curHitEffectIndex + "]" + hitEffect.id + I18n.lang("as_motion_1451031573_4380_3"));
			}
