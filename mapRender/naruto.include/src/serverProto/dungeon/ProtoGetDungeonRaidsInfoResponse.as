package serverProto.dungeon {
	...
	public  final class ProtoGetDungeonRaidsInfoResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.dungeon.ProtoGetDungeonRaidsInfoResponse.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const RAIDS_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.dungeon.ProtoGetDungeonRaidsInfoResponse.raids_info", "raidsInfo", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.dungeon.ProtoDungeonRaidsInfo);
		 ...
		 *  @private
		 */
		public static const RAIDS_REWARD:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.dungeon.ProtoGetDungeonRaidsInfoResponse.raids_reward", "raidsReward", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.dungeon.ProtoRaidsCountReward);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonRaidsInfoResponse.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (raids_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonRaidsInfoResponse.raidsInfo cannot be set twice.');
					}
					++raids_info$count;
