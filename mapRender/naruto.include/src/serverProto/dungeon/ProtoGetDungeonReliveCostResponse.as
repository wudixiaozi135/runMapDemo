package serverProto.dungeon {
	...
	public  final class ProtoGetDungeonReliveCostResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const RELIVE_ITEM_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.relive_item_num", "reliveItemNum", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MONEY_COUPON_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.money_coupon_num", "moneyCouponNum", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MONEY_GOLD_INGOT_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.money_gold_ingot_num", "moneyGoldIngotNum", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NEED_RELIVE_ITEM_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.need_relive_item_num", "needReliveItemNum", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NEED_MONEY_COUPON_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.need_money_coupon_num", "needMoneyCouponNum", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NEED_MONEY_GOLD_INGOT_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.need_money_gold_ingot_num", "needMoneyGoldIngotNum", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (relive_item_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.reliveItemNum cannot be set twice.');
					}
				...
				case 3:
					if (money_coupon_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.moneyCouponNum cannot be set twice.');
					}
				...
				case 4:
					if (money_gold_ingot_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.moneyGoldIngotNum cannot be set twice.');
					}
				...
				case 5:
					if (need_relive_item_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.needReliveItemNum cannot be set twice.');
					}
				...
				case 6:
					if (need_money_coupon_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.needMoneyCouponNum cannot be set twice.');
					}
				...
				case 7:
					if (need_money_gold_ingot_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetDungeonReliveCostResponse.needMoneyGoldIngotNum cannot be set twice.');
					}
