package serverProto.dungeon {
	...
	public  final class ProtoTreasureDungeonInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const DUNGEON_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoTreasureDungeonInfo.dungeon_id", "dungeonId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const IS_OPEN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.dungeon.ProtoTreasureDungeonInfo.is_open", "isOpen", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const OPEN_DAY:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoTreasureDungeonInfo.open_day", "openDay", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NEED_POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoTreasureDungeonInfo.need_power", "needPower", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PASS_TIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoTreasureDungeonInfo.pass_times", "passTimes", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PASS_ULIMIT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoTreasureDungeonInfo.pass_ulimit", "passUlimit", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COOL_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoTreasureDungeonInfo.cool_time", "coolTime", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const EASY_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoTreasureDungeonInfo.easy_open_level", "easyOpenLevel", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NORMAL_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoTreasureDungeonInfo.normal_open_level", "normalOpenLevel", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HARD_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoTreasureDungeonInfo.hard_open_level", "hardOpenLevel", (10 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (dungeon_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.dungeonId cannot be set twice.');
					}
					++dungeon_id$count;
				...
				case 2:
					if (is_open$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.isOpen cannot be set twice.');
					}
					++is_open$count;
				...
				case 4:
					if (need_power$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.needPower cannot be set twice.');
					}
					++need_power$count;
				...
				case 5:
					if (pass_times$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.passTimes cannot be set twice.');
					}
					++pass_times$count;
				...
				case 6:
					if (pass_ulimit$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.passUlimit cannot be set twice.');
					}
					++pass_ulimit$count;
				...
				case 7:
					if (cool_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.coolTime cannot be set twice.');
					}
					++cool_time$count;
				...
				case 8:
					if (easy_open_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.easyOpenLevel cannot be set twice.');
					}
				...
				case 9:
					if (normal_open_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.normalOpenLevel cannot be set twice.');
					}
				...
				case 10:
					if (hard_open_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTreasureDungeonInfo.hardOpenLevel cannot be set twice.');
					}
