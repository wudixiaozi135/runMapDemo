package serverProto.practice {
	...
	public  final class ProtoOpenPracticePosResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.practice.ProtoOpenPracticePosResponse.ret_info", "retInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const PRACTICE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.practice.ProtoOpenPracticePosResponse.practice_info", "practiceInfo", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.practice.ProtoPracticeInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOpenPracticePosResponse.retInfo cannot be set twice.');
					}
					++ret_info$count;
				...
				case 2:
					if (practice_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOpenPracticePosResponse.practiceInfo cannot be set twice.');
					}
					++practice_info$count;
