package serverProto.quiz {
	...
	public  final class ProtoQuizOpenRewardBoxResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.quiz.ProtoQuizOpenRewardBoxResponse.ret_info", "retInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const QUESTION_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.quiz.ProtoQuizOpenRewardBoxResponse.question_info", "questionInfo", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.quiz.ProtoQuestionInfo);
		 ...
		 *  @private
		 */
		public static const REWARD_LIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.quiz.ProtoQuizOpenRewardBoxResponse.reward_list", "rewardList", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoItemInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoQuizOpenRewardBoxResponse.retInfo cannot be set twice.');
					}
					++ret_info$count;
				...
				case 2:
					if (question_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoQuizOpenRewardBoxResponse.questionInfo cannot be set twice.');
					}
					++question_info$count;
