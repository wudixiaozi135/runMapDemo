package serverProto.npc {
	...
	public  final class ProtoGetNpcLocationResquest extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.npc.ProtoGetNpcLocationResquest.scene_id", "sceneId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (scene_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetNpcLocationResquest.sceneId cannot be set twice.');
					}
					++scene_id$count;
