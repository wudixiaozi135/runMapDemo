package serverProto.baseInfo {
	...
	public  final class ProtoNinjaInfoChangeNotify extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const NINJA_INFO:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoNinjaInfoChangeNotify.ninja_info", "ninjaInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.baseInfo.ProtoNinjaInfo);
