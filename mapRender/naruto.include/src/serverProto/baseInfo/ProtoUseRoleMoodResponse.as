package serverProto.baseInfo {
	...
	public  final class ProtoUseRoleMoodResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoUseRoleMoodResponse.ret_info", "retInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const MOOD_LIST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoUseRoleMoodResponse.mood_list", "moodList", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.baseInfo.ProtoRoleMoodList);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoUseRoleMoodResponse.retInfo cannot be set twice.');
					}
					++ret_info$count;
				...
				case 2:
					if (mood_list$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoUseRoleMoodResponse.moodList cannot be set twice.');
					}
					++mood_list$count;
