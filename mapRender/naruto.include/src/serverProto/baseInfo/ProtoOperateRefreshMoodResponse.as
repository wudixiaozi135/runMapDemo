package serverProto.baseInfo {
	...
	public  final class ProtoOperateRefreshMoodResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoOperateRefreshMoodResponse.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const NINJA_MOOD_DETAIL_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoOperateRefreshMoodResponse.ninja_mood_detail_info", "ninjaMoodDetailInfo", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.baseInfo.ProtoNinjaMoodDetailInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOperateRefreshMoodResponse.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (ninja_mood_detail_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOperateRefreshMoodResponse.ninjaMoodDetailInfo cannot be set twice.');
					}
