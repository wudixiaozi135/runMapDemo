package serverProto.activityHub {
	...
	public  final class ProtoActivityHubNodeInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHubNodeInfo.id", "id", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TIME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.activityHub.ProtoActivityHubNodeInfo.time", "time", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const DAY:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHubNodeInfo.day", "day", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SPECIAL_DAY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.activityHub.ProtoActivityHubNodeInfo.special_day", "specialDay", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ALL_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHubNodeInfo.all_time", "allTime", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REMAINDER_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHubNodeInfo.remainder_time", "remainderTime", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const STATUS:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.activityHub.ProtoActivityHubNodeInfo.status", "status", (7 << 3) | com.netease.protobuf.WireType.VARINT, serverProto.activityHub.ProtoActivityStatus);
		 ...
		 *  @private
		 */
		public static const MEET_SPECIAL_CONDITION:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.activityHub.ProtoActivityHubNodeInfo.meet_special_condition", "meetSpecialCondition", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.id cannot be set twice.');
					}
					++id$count;
				...
				case 2:
					if (time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.time cannot be set twice.');
					}
					++time$count;
				...
				case 4:
					if (special_day$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.specialDay cannot be set twice.');
					}
					++special_day$count;
				...
				case 5:
					if (all_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.allTime cannot be set twice.');
					}
					++all_time$count;
				...
				case 6:
					if (remainder_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.remainderTime cannot be set twice.');
					}
				...
				case 7:
					if (status$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.status cannot be set twice.');
					}
					++status$count;
				...
				case 8:
					if (meet_special_condition$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoActivityHubNodeInfo.meetSpecialCondition cannot be set twice.');
					}
