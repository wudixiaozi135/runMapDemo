package serverProto.activity {
	...
	public  final class ProtoJizipaiExchange extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SCORE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoJizipaiExchange.score", "score", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoJizipaiExchange.award", "award", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoItemInfo);
		 ...
		 *  @private
		 */
		public static const LIMIT_EXCHANGE_NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoJizipaiExchange.limit_exchange_num", "limitExchangeNum", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const EXCHANGED_NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoJizipaiExchange.exchanged_num", "exchangedNum", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (score$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoJizipaiExchange.score cannot be set twice.');
					}
					++score$count;
				...
				case 2:
					if (award$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoJizipaiExchange.award cannot be set twice.');
					}
					++award$count;
				...
				case 3:
					if (limit_exchange_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoJizipaiExchange.limitExchangeNum cannot be set twice.');
					}
				...
				case 4:
					if (exchanged_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoJizipaiExchange.exchangedNum cannot be set twice.');
					}
					++exchanged_num$count;
