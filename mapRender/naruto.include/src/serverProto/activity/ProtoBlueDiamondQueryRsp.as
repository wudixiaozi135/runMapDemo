package serverProto.activity {
	...
	public  final class ProtoBlueDiamondQueryRsp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoBlueDiamondQueryRsp.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const DAILY_LEVEL_AWARDS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoBlueDiamondQueryRsp.daily_level_awards", "dailyLevelAwards", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.activity.ProtoAwardPackageBox);
		 ...
		 *  @private
		 */
		public static const DAILY_EXTRA_AWARDS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoBlueDiamondQueryRsp.daily_extra_awards", "dailyExtraAwards", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.activity.ProtoAwardPackageBox);
		 ...
		 *  @private
		 */
		public static const FRESHMAN_ONCE_AWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoBlueDiamondQueryRsp.freshman_once_award", "freshmanOnceAward", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.activity.ProtoAwardPackageBox);
		 ...
		 *  @private
		 */
		public static const UPGRADE_AWARDS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoBlueDiamondQueryRsp.upgrade_awards", "upgradeAwards", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.activity.ProtoAwardPackageBox);
		 ...
		 *  @private
		 */
		public static const AWARD_LEVELS:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoBlueDiamondQueryRsp.award_levels", "awardLevels", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoBlueDiamondQueryRsp.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 4:
					if (freshman_once_award$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoBlueDiamondQueryRsp.freshmanOnceAward cannot be set twice.');
					}
