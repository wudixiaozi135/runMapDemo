package serverProto.activity {
	...
	public  final class ProtoOpenServiceAwardReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TAB_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceAwardReq.tab_idx", "tabIdx", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceAwardReq.box_id", "boxId", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (tab_idx$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOpenServiceAwardReq.tabIdx cannot be set twice.');
					}
					++tab_idx$count;
				...
				case 2:
					if (box_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOpenServiceAwardReq.boxId cannot be set twice.');
					}
					++box_id$count;
