package serverProto.activity {
	...
	public  final class ProtoRechargeGiftAwardReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeGiftAwardReq.box_id", "boxId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AWARD_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeGiftAwardReq.award_idx", "awardIdx", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (box_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeGiftAwardReq.boxId cannot be set twice.');
					}
					++box_id$count;
				...
				case 2:
					if (award_idx$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeGiftAwardReq.awardIdx cannot be set twice.');
					}
					++award_idx$count;
