package serverProto.activity {
	...
	public  final class ProtoRechargeRebateRsp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoRechargeRebateRsp.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const ACTIVITY_BEGIN_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeRebateRsp.activity_begin_time", "activityBeginTime", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ACTIVITY_END_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeRebateRsp.activity_end_time", "activityEndTime", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REBATED:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeRebateRsp.rebated", "rebated", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AVAILABLE_REBATE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeRebateRsp.available_rebate", "availableRebate", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REMAIND_REBATE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeRebateRsp.remaind_rebate", "remaindRebate", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RATE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeRebateRsp.rate", "rate", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (activity_begin_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.activityBeginTime cannot be set twice.');
					}
				...
				case 3:
					if (activity_end_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.activityEndTime cannot be set twice.');
					}
				...
				case 4:
					if (rebated$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.rebated cannot be set twice.');
					}
					++rebated$count;
				...
				case 5:
					if (available_rebate$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.availableRebate cannot be set twice.');
					}
				...
				case 6:
					if (remaind_rebate$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.remaindRebate cannot be set twice.');
					}
				...
				case 7:
					if (rate$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoRechargeRebateRsp.rate cannot be set twice.');
					}
					++rate$count;
