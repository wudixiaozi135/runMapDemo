package serverProto.activity {
	...
	public  final class ProtoOnlineGiftQueryRsp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoOnlineGiftQueryRsp.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const LEFT_AWARD_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activity.ProtoOnlineGiftQueryRsp.left_award_time", "leftAwardTime", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const AWARD_LIST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoOnlineGiftQueryRsp.award_list", "awardList", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.activity.ProtoAwardList);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOnlineGiftQueryRsp.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (left_award_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOnlineGiftQueryRsp.leftAwardTime cannot be set twice.');
					}
				...
				case 3:
					if (award_list$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOnlineGiftQueryRsp.awardList cannot be set twice.');
					}
					++award_list$count;
