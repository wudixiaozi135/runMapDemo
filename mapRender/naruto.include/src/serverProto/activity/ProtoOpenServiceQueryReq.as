package serverProto.activity {
	...
	public  final class ProtoOpenServiceQueryReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TAB_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceQueryReq.tab_idx", "tabIdx", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (tab_idx$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOpenServiceQueryReq.tabIdx cannot be set twice.');
					}
					++tab_idx$count;
