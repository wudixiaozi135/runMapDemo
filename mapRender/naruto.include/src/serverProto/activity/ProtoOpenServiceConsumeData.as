package serverProto.activity {
	...
	public  final class ProtoOpenServiceConsumeData extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CONSUME_GOLDINGOT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceConsumeData.consume_goldingot", "consumeGoldingot", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BOX_GOLDINGOT:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceConsumeData.box_goldingot", "boxGoldingot", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PACKAGE_BOXES:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoOpenServiceConsumeData.package_boxes", "packageBoxes", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.activity.ProtoAwardPackageBox);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (consume_goldingot$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoOpenServiceConsumeData.consumeGoldingot cannot be set twice.');
					}
