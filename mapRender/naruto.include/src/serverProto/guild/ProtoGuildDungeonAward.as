package serverProto.guild {
	...
	public  final class ProtoGuildDungeonAward extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const MONEY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildDungeonAward.money", "money", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const GUILD_CONTRI:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildDungeonAward.guild_contri", "guildContri", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const GUILD_MONEY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildDungeonAward.guild_money", "guildMoney", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (money$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGuildDungeonAward.money cannot be set twice.');
					}
					++money$count;
				...
				case 2:
					if (guild_contri$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGuildDungeonAward.guildContri cannot be set twice.');
					}
					++guild_contri$count;
				...
				case 3:
					if (guild_money$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGuildDungeonAward.guildMoney cannot be set twice.');
					}
					++guild_money$count;
