package serverProto.guild {
	...
	public  final class ProtoGvGSelfAjustBattleFieldPosReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const PLAYER_POS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.guild.ProtoGvGSelfAjustBattleFieldPosReq.player_pos", "playerPos", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.guild.ProtoGvGBattleFieldPlayerPos);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (player_pos$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGvGSelfAjustBattleFieldPosReq.playerPos cannot be set twice.');
					}
					++player_pos$count;
