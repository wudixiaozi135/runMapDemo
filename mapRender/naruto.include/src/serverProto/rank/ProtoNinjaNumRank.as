package serverProto.rank {
	...
	public  final class ProtoNinjaNumRank extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RANK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaNumRank.rank", "rank", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoNinjaNumRank.player_id", "playerId", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
		 ...
		 *  @private
		 */
		public static const PLAYER_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rank.ProtoNinjaNumRank.player_name", "playerName", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ROLE_CATEGORY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaNumRank.role_category", "roleCategory", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ROLE_LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaNumRank.role_level", "roleLevel", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NINJA_NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaNumRank.ninja_num", "ninjaNum", (6 << 3) | com.netease.protobuf.WireType.VARINT);

		private var ninja_num$field:uint;

		public function clearNinjaNum():void {
			hasField$0 &= 0xfffffff7;
			ninja_num$field = new uint();
		}
		...
		public function set ninjaNum(value:uint):void {
			hasField$0 |= 0x8;
			ninja_num$field = value;
		}

		public function get ninjaNum():uint {
			return ninja_num$field;
		}

		/**
		 *  @private
		 */
		public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rank.ProtoNinjaNumRank.vip_level", "vipLevel", (7 << 3) | com.netease.protobuf.WireType.VARINT, serverProto.inc.ProtoPlayerVipLevel);
		 ...
		 *  @private
		 */
		public static const TITLE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaNumRank.title_id", "titleId", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoNinjaNumRank.diamond_info", "diamondInfo", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoDiamondInfo);
		...
		override used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasNinjaNum) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_UINT32(output, ninja_num$field);
			}
			if (hasVipLevel) {
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.rank cannot be set twice.');
					}
					++rank$count;
				...
				case 2:
					if (player_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.playerId cannot be set twice.');
					}
					++player_id$count;
				...
				case 3:
					if (player_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.playerName cannot be set twice.');
					}
					++player_name$count;
				...
				case 4:
					if (role_category$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.roleCategory cannot be set twice.');
					}
					++role_category$count;
				...
				case 5:
					if (role_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.roleLevel cannot be set twice.');
					}
					++role_level$count;
					this.roleLevel = com.netease.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 6:
					if (ninja_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.ninjaNum cannot be set twice.');
					}
					++ninja_num$count;
					this.ninjaNum = com.netease.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 7:
					if (vip_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.vipLevel cannot be set twice.');
					}
					++vip_level$count;
				...
				case 8:
					if (title_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.titleId cannot be set twice.');
					}
					++title_id$count;
				...
				case 9:
					if (diamond_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRank.diamondInfo cannot be set twice.');
					}
					++diamond_info$count;
