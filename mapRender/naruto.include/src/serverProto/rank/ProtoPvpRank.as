package serverProto.rank {
	...
	public  final class ProtoPvpRank extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RANK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoPvpRank.rank", "rank", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoPvpRank.player_id", "playerId", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
		 ...
		 *  @private
		 */
		public static const PLAYER_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rank.ProtoPvpRank.player_name", "playerName", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ROLE_CATEGORY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoPvpRank.role_category", "roleCategory", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ROLE_LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoPvpRank.role_level", "roleLevel", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const MAX_WIN_COUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoPvpRank.max_win_count", "maxWinCount", (6 << 3) | com.netease.protobuf.WireType.VARINT);

		private var max_win_count$field:uint;

		public function clearMaxWinCount():void {
			hasField$0 &= 0xfffffff7;
			max_win_count$field = new uint();
		}
		...
		public function set maxWinCount(value:uint):void {
			hasField$0 |= 0x8;
			max_win_count$field = value;
		}

		public function get maxWinCount():uint {
			return max_win_count$field;
		}

		/**
		 *  @private
		 */
		public static const SCORE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoPvpRank.score", "score", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rank.ProtoPvpRank.vip_level", "vipLevel", (8 << 3) | com.netease.protobuf.WireType.VARINT, serverProto.inc.ProtoPlayerVipLevel);
		 ...
		 *  @private
		 */
		public static const TITLE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoPvpRank.title_id", "titleId", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoPvpRank.diamond_info", "diamondInfo", (10 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoDiamondInfo);
		...
		override used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasMaxWinCount) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_UINT32(output, max_win_count$field);
			}
			if (hasScore) {
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			var max_win_count$count:uint = 0;
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.rank cannot be set twice.');
					}
					++rank$count;
				...
				case 2:
					if (player_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.playerId cannot be set twice.');
					}
					++player_id$count;
				...
				case 3:
					if (player_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.playerName cannot be set twice.');
					}
					++player_name$count;
				...
				case 4:
					if (role_category$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.roleCategory cannot be set twice.');
					}
					++role_category$count;
				...
				case 5:
					if (role_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.roleLevel cannot be set twice.');
					}
					++role_level$count;
					this.roleLevel = com.netease.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 6:
					if (max_win_count$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.maxWinCount cannot be set twice.');
					}
					++max_win_count$count;
					this.maxWinCount = com.netease.protobuf.ReadUtils.read$TYPE_UINT32(input);
					break;
				case 7:
					if (score$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.score cannot be set twice.');
					}
					++score$count;
				...
				case 8:
					if (vip_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.vipLevel cannot be set twice.');
					}
					++vip_level$count;
				...
				case 9:
					if (title_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.titleId cannot be set twice.');
					}
					++title_id$count;
				...
				case 10:
					if (diamond_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoPvpRank.diamondInfo cannot be set twice.');
					}
					++diamond_info$count;
