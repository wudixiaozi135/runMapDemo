package serverProto.rank {
	...
	public  final class ProtoNinjaNumRankReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const MERGED_RANK:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.rank.ProtoNinjaNumRankReq.merged_rank", "mergedRank", (1 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (merged_rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoNinjaNumRankReq.mergedRank cannot be set twice.');
					}
					++merged_rank$count;
