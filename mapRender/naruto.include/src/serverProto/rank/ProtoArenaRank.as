package serverProto.rank {
	...
	public  final class ProtoArenaRank extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RANK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoArenaRank.rank", "rank", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoArenaRank.player_id", "playerId", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
		 ...
		 *  @private
		 */
		public static const PLAYER_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rank.ProtoArenaRank.player_name", "playerName", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const ROLE_CATEGORY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoArenaRank.role_category", "roleCategory", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ROLE_LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoArenaRank.role_level", "roleLevel", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SCORE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoArenaRank.score", "score", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoArenaRank.level", "level", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rank.ProtoArenaRank.vip_level", "vipLevel", (8 << 3) | com.netease.protobuf.WireType.VARINT, serverProto.inc.ProtoPlayerVipLevel);
		 ...
		 *  @private
		 */
		public static const TITLE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoArenaRank.title_id", "titleId", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoArenaRank.diamond_info", "diamondInfo", (10 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoDiamondInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.rank cannot be set twice.');
					}
					++rank$count;
				...
				case 2:
					if (player_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.playerId cannot be set twice.');
					}
					++player_id$count;
				...
				case 3:
					if (player_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.playerName cannot be set twice.');
					}
					++player_name$count;
				...
				case 4:
					if (role_category$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.roleCategory cannot be set twice.');
					}
					++role_category$count;
				...
				case 5:
					if (role_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.roleLevel cannot be set twice.');
					}
					++role_level$count;
				...
				case 6:
					if (score$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.score cannot be set twice.');
					}
					++score$count;
				...
				case 7:
					if (level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.level cannot be set twice.');
					}
					++level$count;
				...
				case 8:
					if (vip_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.vipLevel cannot be set twice.');
					}
					++vip_level$count;
				...
				case 9:
					if (title_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.titleId cannot be set twice.');
					}
					++title_id$count;
				...
				case 10:
					if (diamond_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoArenaRank.diamondInfo cannot be set twice.');
					}
					++diamond_info$count;
