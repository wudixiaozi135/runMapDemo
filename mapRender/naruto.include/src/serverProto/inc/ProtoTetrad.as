package serverProto.inc {
	...
	public  final class ProtoTetrad extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.inc.ProtoTetrad.type", "type", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DATA1:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.inc.ProtoTetrad.data1", "data1", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DATA2:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.inc.ProtoTetrad.data2", "data2", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const DATA3:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.inc.ProtoTetrad.data3", "data3", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (type$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTetrad.type cannot be set twice.');
					}
					++type$count;
				...
				case 2:
					if (data1$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTetrad.data1 cannot be set twice.');
					}
					++data1$count;
				...
				case 3:
					if (data2$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTetrad.data2 cannot be set twice.');
					}
					++data2$count;
				...
				case 4:
					if (data3$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoTetrad.data3 cannot be set twice.');
					}
					++data3$count;
