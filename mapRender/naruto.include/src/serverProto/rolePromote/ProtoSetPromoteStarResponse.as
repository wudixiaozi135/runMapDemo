package serverProto.rolePromote {
	...
	public  final class ProtoSetPromoteStarResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rolePromote.ProtoSetPromoteStarResponse.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const REMAIN_STAR:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.rolePromote.ProtoSetPromoteStarResponse.remain_star", "remainStar", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PREV_START:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.rolePromote.ProtoSetPromoteStarResponse.prev_start", "prevStart", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ATTR_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rolePromote.ProtoSetPromoteStarResponse.attr_info", "attrInfo", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.rolePromote.ProtoPromoteAttrInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoSetPromoteStarResponse.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (remain_star$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoSetPromoteStarResponse.remainStar cannot be set twice.');
					}
					++remain_star$count;
				...
				case 3:
					if (prev_start$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoSetPromoteStarResponse.prevStart cannot be set twice.');
					}
					++prev_start$count;
				...
				case 4:
					if (attr_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoSetPromoteStarResponse.attrInfo cannot be set twice.');
					}
					++attr_info$count;
