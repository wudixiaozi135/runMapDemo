package serverProto.bag {
	...
	public  final class ProtoSellItemReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const INDEX_INFO:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.bag.ProtoSellItemReq.index_info", "indexInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.bag.ProtoItemIndex);
