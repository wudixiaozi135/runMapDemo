package serverProto.bag {
	...
	public  final class ProtoAddItemResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.bag.ProtoAddItemResponse.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.bag.ProtoAddItemResponse.vip_level", "vipLevel", (2 << 3) | com.netease.protobuf.WireType.VARINT, serverProto.inc.ProtoPlayerVipLevel);
		 ...
		 *  @private
		 */
		public static const VIP_EXPIRED_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bag.ProtoAddItemResponse.vip_expired_time", "vipExpiredTime", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const VIP_REMAINDER_DAY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bag.ProtoAddItemResponse.vip_remainder_day", "vipRemainderDay", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoAddItemResponse.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (vip_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoAddItemResponse.vipLevel cannot be set twice.');
					}
					++vip_level$count;
				...
				case 3:
					if (vip_expired_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoAddItemResponse.vipExpiredTime cannot be set twice.');
					}
				...
				case 4:
					if (vip_remainder_day$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoAddItemResponse.vipRemainderDay cannot be set twice.');
					}
