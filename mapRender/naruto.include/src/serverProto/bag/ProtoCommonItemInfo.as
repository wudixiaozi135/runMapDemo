package serverProto.bag {
	...
	public  final class ProtoCommonItemInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bag.ProtoCommonItemInfo.id", "id", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bag.ProtoCommonItemInfo.num", "num", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const EXPIRED_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bag.ProtoCommonItemInfo.expired_time", "expiredTime", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const EXPIRED_REMAINDER_SECOND:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.bag.ProtoCommonItemInfo.expired_remainder_second", "expiredRemainderSecond", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoCommonItemInfo.id cannot be set twice.');
					}
					++id$count;
				...
				case 2:
					if (num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoCommonItemInfo.num cannot be set twice.');
					}
					++num$count;
				...
				case 3:
					if (expired_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoCommonItemInfo.expiredTime cannot be set twice.');
					}
					++expired_time$count;
				...
				case 4:
					if (expired_remainder_second$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoCommonItemInfo.expiredRemainderSecond cannot be set twice.');
					}
