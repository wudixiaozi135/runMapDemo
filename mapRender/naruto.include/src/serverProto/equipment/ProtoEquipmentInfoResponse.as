package serverProto.equipment {
	...
	public  final class ProtoEquipmentInfoResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoEquipmentInfoResponse.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const NINJA_EQUIP:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoEquipmentInfoResponse.ninja_equip", "ninjaEquip", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.equipment.ProtoFormationEquipmentInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoEquipmentInfoResponse.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (ninja_equip$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoEquipmentInfoResponse.ninjaEquip cannot be set twice.');
					}
					++ninja_equip$count;
