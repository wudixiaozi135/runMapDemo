package serverProto.equipment {
	...
	public  final class ProtoEquipmentInfoRequest extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const KEY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoEquipmentInfoRequest.key", "key", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (key$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoEquipmentInfoRequest.key cannot be set twice.');
					}
					++key$count;
