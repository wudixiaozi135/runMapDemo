package serverProto.equipment {
	...
	public  final class ProtoGetEquipForgeQualityReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const EQUIP_SEQUENCE:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("serverProto.equipment.ProtoGetEquipForgeQualityReq.equip_sequence", "equipSequence", (1 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (equip_sequence$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetEquipForgeQualityReq.equipSequence cannot be set twice.');
					}
