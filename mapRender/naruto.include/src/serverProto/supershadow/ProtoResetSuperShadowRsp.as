package serverProto.supershadow {
	...
	public  final class ProtoResetSuperShadowRsp extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.supershadow.ProtoResetSuperShadowRsp.ret", "ret", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoRetInfo);
		 ...
		 *  @private
		 */
		public static const SUPER_SHADOW_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.supershadow.ProtoResetSuperShadowRsp.super_shadow_info", "superShadowInfo", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.supershadow.ProtoSuperShadowInfo);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ret$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoResetSuperShadowRsp.ret cannot be set twice.');
					}
					++ret$count;
				...
				case 2:
					if (super_shadow_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoResetSuperShadowRsp.superShadowInfo cannot be set twice.');
					}
