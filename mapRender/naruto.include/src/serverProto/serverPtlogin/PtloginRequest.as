package serverProto.serverPtlogin {
	...
	public  final class PtloginRequest extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SKEY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.serverPtlogin.PtloginRequest.skey", "skey", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const SEPERATE_SKEY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.serverPtlogin.PtloginRequest.seperate_skey", "seperateSkey", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (skey$count != 0) {
						throw new flash.errors.IOError('Bad data format: PtloginRequest.skey cannot be set twice.');
					}
					++skey$count;
				...
				case 2:
					if (seperate_skey$count != 0) {
						throw new flash.errors.IOError('Bad data format: PtloginRequest.seperateSkey cannot be set twice.');
					}
					++seperate_skey$count;
