package serverProto.fashion {
	...
	public  final class ProtoFashionSetShowFlagReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const SHOW_FLAG:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionSetShowFlagReq.show_flag", "showFlag", (1 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (show_flag$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionSetShowFlagReq.showFlag cannot be set twice.');
					}
					++show_flag$count;
