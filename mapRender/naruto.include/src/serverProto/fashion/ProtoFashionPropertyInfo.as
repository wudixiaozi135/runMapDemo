package serverProto.fashion {
	...
	public  final class ProtoFashionPropertyInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const HP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.hp", "hp", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BODY_ATTACK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.body_attack", "bodyAttack", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BODY_DEFENSE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.body_defense", "bodyDefense", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NINJA_ATTACK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.ninja_attack", "ninjaAttack", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NINJA_DEFENSE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.ninja_defense", "ninjaDefense", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const SPEED:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.speed", "speed", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CRIT_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.crit_value", "critValue", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CRIT_DAMAGE_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.crit_damage_value", "critDamageValue", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const COMBO_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.combo_value", "comboValue", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CONTROL_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.fashion.ProtoFashionPropertyInfo.control_value", "controlValue", (10 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (hp$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.hp cannot be set twice.');
					}
					++hp$count;
				...
				case 2:
					if (body_attack$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.bodyAttack cannot be set twice.');
					}
					++body_attack$count;
				...
				case 3:
					if (body_defense$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.bodyDefense cannot be set twice.');
					}
					++body_defense$count;
				...
				case 4:
					if (ninja_attack$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.ninjaAttack cannot be set twice.');
					}
					++ninja_attack$count;
				...
				case 5:
					if (ninja_defense$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.ninjaDefense cannot be set twice.');
					}
					++ninja_defense$count;
				...
				case 6:
					if (speed$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.speed cannot be set twice.');
					}
					++speed$count;
				...
				case 7:
					if (crit_value$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.critValue cannot be set twice.');
					}
					++crit_value$count;
				...
				case 8:
					if (crit_damage_value$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.critDamageValue cannot be set twice.');
					}
				...
				case 9:
					if (combo_value$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.comboValue cannot be set twice.');
					}
					++combo_value$count;
				...
				case 10:
					if (control_value$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFashionPropertyInfo.controlValue cannot be set twice.');
					}
					++control_value$count;
