package serverProto.player {
	...
	public  final class ProtoGetPlayerTipsInfoReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.player.ProtoGetPlayerTipsInfoReq.player_id", "playerId", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (player_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetPlayerTipsInfoReq.playerId cannot be set twice.');
					}
					++player_id$count;
