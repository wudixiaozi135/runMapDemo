package serverProto.ninjaSystem {
	...
	public  final class ProtoGetNinjaPackageRequest extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const NINJA_SOURCE_TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.ninjaSystem.ProtoGetNinjaPackageRequest.ninja_source_type", "ninjaSourceType", (1 << 3) | com.netease.protobuf.WireType.VARINT, serverProto.inc.NinjaSourceType);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (ninja_source_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoGetNinjaPackageRequest.ninjaSourceType cannot be set twice.');
					}
