package serverProto.family {
	...
	public  final class ProtoFriendWishTreeInfo extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TREE_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.tree_level", "treeLevel", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TREE_EXP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.tree_exp", "treeExp", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const GROWTH_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.growth_value", "growthValue", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const GROWTH_VALUE_MAX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.growth_value_max", "growthValueMax", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CAN_HELP_WATER:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.can_help_water", "canHelpWater", (5 << 3) | com.netease.protobuf.WireType.VARINT);

		private var can_help_water$field:int;

		public function clearCanHelpWater():void {
			hasField$0 &= 0xffffffef;
			can_help_water$field = new int();
		}
		...
		public function set canHelpWater(value:int):void {
			hasField$0 |= 0x10;
			can_help_water$field = value;
		}

		public function get canHelpWater():int {
			return can_help_water$field;
		}

		/**
		 *  @private
		 */
		public static const MAX_TREE_EXP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.max_tree_exp", "maxTreeExp", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LEFT_HELP_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.left_help_num", "leftHelpNum", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasCanHelpWater) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, can_help_water$field);
			}
			if (hasMaxTreeExp) {
		...
		override used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			var can_help_water$count:uint = 0;
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (tree_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.treeLevel cannot be set twice.');
					}
					++tree_level$count;
				...
				case 2:
					if (tree_exp$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.treeExp cannot be set twice.');
					}
					++tree_exp$count;
				...
				case 3:
					if (growth_value$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.growthValue cannot be set twice.');
					}
					++growth_value$count;
				...
				case 4:
					if (growth_value_max$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.growthValueMax cannot be set twice.');
					}
					++growth_value_max$count;
					this.growthValueMax = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 5:
					if (can_help_water$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.canHelpWater cannot be set twice.');
					}
					++can_help_water$count;
					this.canHelpWater = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 6:
					if (max_tree_exp$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.maxTreeExp cannot be set twice.');
					}
					++max_tree_exp$count;
				...
				case 7:
					if (left_help_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoFriendWishTreeInfo.leftHelpNum cannot be set twice.');
					}
					++left_help_num$count;
