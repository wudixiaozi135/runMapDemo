package serverProto.family {
	...
	public  final class ProtoDispatchNinjaChooseReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const FRIEND_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoDispatchNinjaChooseReq.friend_id", "friendId", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
		 ...
		 *  @private
		 */
		public static const FRIEND_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.family.ProtoDispatchNinjaChooseReq.friend_name", "friendName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.family.ProtoDispatchNinjaChooseReq.idx", "idx", (3 << 3) | com.netease.protobuf.WireType.VARINT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (friend_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoDispatchNinjaChooseReq.friendId cannot be set twice.');
					}
					++friend_id$count;
				...
				case 2:
					if (friend_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoDispatchNinjaChooseReq.friendName cannot be set twice.');
					}
					++friend_name$count;
				...
				case 3:
					if (idx$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoDispatchNinjaChooseReq.idx cannot be set twice.');
					}
					++idx$count;
