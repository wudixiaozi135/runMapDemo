package serverProto.family {
	...
	public  final class ProtoInnerDispatchTaskDoneNotify extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const FRIEND_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoInnerDispatchTaskDoneNotify.friend_id", "friendId", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
		 ...
		 *  @private
		 */
		public static const FRIEND_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.family.ProtoInnerDispatchTaskDoneNotify.friend_name", "friendName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (friend_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoInnerDispatchTaskDoneNotify.friendId cannot be set twice.');
					}
					++friend_id$count;
				...
				case 2:
					if (friend_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoInnerDispatchTaskDoneNotify.friendName cannot be set twice.');
					}
					++friend_name$count;
