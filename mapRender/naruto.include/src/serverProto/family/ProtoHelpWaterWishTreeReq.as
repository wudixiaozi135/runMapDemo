package serverProto.family {
	...
	public  final class ProtoHelpWaterWishTreeReq extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const FRIEND_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoHelpWaterWishTreeReq.friend_id", "friendId", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, serverProto.inc.ProtoPlayerKey);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (friend_id$count != 0) {
						throw new flash.errors.IOError('Bad data format: ProtoHelpWaterWishTreeReq.friendId cannot be set twice.');
					}
					++friend_id$count;
