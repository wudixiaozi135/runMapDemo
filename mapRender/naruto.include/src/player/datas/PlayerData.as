...
//		public static const PROPERTY_POSITION:String = "position";
		...
		public function equal3(protoPlayerKey:ProtoPlayerKey):Boolean
		{
			return equeal(protoPlayerKey.uin, protoPlayerKey.roleId, protoPlayerKey.svrId);
		}
...
//			dispatchUpdate(PROPERTY_POSITION);
		 ...
		 * 玩家称号
		 */
		public function get title():RankTitleCfgInfo { return _title; }
