package com.tencent.morefun.naruto.plugin.battle.view
{
	...
	public class DelayValueBar extends EventDispatcher
	{
		...
		public function DelayValueBar(res:MovieClip)	
		{
			super();
		...
		public function update(curValue:int, maxValue:int):void
		{
			...
			TweenManager.killTweensOf(this);
			TweenManager.addTweenTo(this,0.3,{curRealValue:curValue, delay:0.2, onUpdate:onUpdate, onComplete:onComplete});
		}
