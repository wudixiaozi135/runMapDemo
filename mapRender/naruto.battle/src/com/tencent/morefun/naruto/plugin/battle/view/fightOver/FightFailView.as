package com.tencent.morefun.naruto.plugin.battle.view.fightOver 
{
	...
	import ui.battle.FightLoseUI;

	public class FightFailView 
	{
		...
		public function FightFailView(isShowDamage:Boolean) 
		{
			this.isShowDamage = isShowDamage;
			
			_ui = new FightLoseUI();
			_ui.gotoAndPlay(1);
			new PlayUISoundCommand(UISoundDef.BATTLE_LOSE).call();
