package com.map.controls
{
	...
	import com.map.element.IDIYDeepElementProvider;
...
//			}
		...
		{
			updateDeep(_layers[MapLayerDef.BOTTOM_ELEMENT]);
			updateDeep(_layers[MapLayerDef.MIDDLE_ELEMENT]);
			updateDeep(_layers[MapLayerDef.FRONT_ELEMENT]);
		}
		...
		public function dispose():void
		{
			...
			TimerProvider.removeTimeTask(500, checkDeep);
		}
		...
		private function updateCheckDeep():void
		{
			if (_isStarted)
			{
				TimerProvider.addTimeTask(500, checkDeep);
			}
		}
